...
config_table.local = true
config_table.browser = :firefox
...
config_table.grid_url = ENV['GRID_URL'] ? ENV['GRID_URL'] : 'http://localhost:4441'
config_table.proxy_based_url = ENV['PROXY_URL'] ? ENV['PROXY_URL'] : 'my_proxy:8080'
